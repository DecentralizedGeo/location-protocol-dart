...
class ChainAddresses {
  ...
  /// The EAS contract version string used in EIP-712 domain construction.
  ///
  /// This must match the value returned by `EAS.version()` on the target chain.
  /// Using the wrong version produces attestations that are internally valid
  /// but rejected by standard EAS tooling (e.g. the TypeScript SDK).
